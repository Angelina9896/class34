...
var blower
var greystar,yellowstar,onestar
var star_display
...
function preload()
{
  ...
  greystar=loadAnimation("empty.png")
  yellowstar=loadAnimation("stars.png")
...
function setup() 
{
  ...
  star_display.addAnimation("greystar",greystar)
  star_display.scale=0.2
  star_display.addAnimation("yellowstar",yellowstar)
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if (collide(fruit,star1,20)==true){
     star1.visible=false
     star_display.changeAnimation("onestar",onestar)
   }

   if (collide(fruit,star2,20)==true){
    star2.visible=false
    star_display.changeAnimation("yellowstar",yellowstar)
  }
